...
try:
    exec("import pptx")
    print("[DONE] python-pptx is already installed")
except:
    print("[ERROR] python-pptx isn't installed ")
...
DEFAULT_INPUT_PATH = os.path.expanduser("~/D:/code/codeutsav/video to frame/Extract-Frame-from-Videos/save/videos")
DEFAULT_OUTPUT_PATH = os.path.expanduser("~/D:/code/codeutsav/video to frame/Extract-Frame-from-Videos/save/videos")
